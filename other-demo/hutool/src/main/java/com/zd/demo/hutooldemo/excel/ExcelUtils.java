...
public class ExcelUtils {
     ...
     * 修改时间：
     */
    private static void setTitle(HSSFWorkbook workbook, HSSFSheet sheet, List<String> str) {
        try {
        ...
        try {
            ...
            for (List<String> datum : data) {
                ...
                for (int i = 0; i < datum.size(); i++) {
                    row.createCell(i).setCellValue(datum.get(i));
                }
                rowNum++;
            }
            log.info("表格赋值成功！");
    ...
    public static void main(String[] args) {
        try {
            String fileName = "D:/testCode/test.xlsx";
