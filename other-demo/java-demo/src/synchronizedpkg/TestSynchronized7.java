 ...
 * @Description: 验证：两个线程分别同时访问静态synchronized和非静态synchronized方法，线程不安全
 * 问题原因： 线程1的锁是类锁（*.class）对象，线程2的锁是方法锁（this）对象,两个线程的锁不一样，自然不会互相影响，所以会并行执行。
 * @Author: zhangdi
 * @Date: 2020年11月26日 09:27
 **/
public class TestSynchronized7 implements Runnable {
    static TestSynchronized7 instance = new TestSynchronized7();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("测试结束:两个线程分别同时访问静态synchronized和非静态synchronized方法，线程不安全。");
    }
}